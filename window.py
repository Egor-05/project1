...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.btn_no.setGeometry(QtCore.QRect(20, 555, 80, 25))
        self.btn_no.setObjectName("pushButton")

        self.btn_yes = QtWidgets.QPushButton(Dialog)
        self.btn_yes.setGeometry(QtCore.QRect(260, 555, 80, 25))
        ...
        self.image.setGeometry(QtCore.QRect(30, 90, 320, 300))
        self.image.setText("")
        self.image.setObjectName("label")

        self.question = QtWidgets.QLabel(Dialog)
        self.question.setGeometry(QtCore.QRect(30, 410, 300, 90))
        font = QtGui.QFont()
